...
var productListApiUrl = 'http://127.0.0.1:5000/getProducts';  //getting products from database to display
var uomListApiUrl = 'http://127.0.0.1:5000/getUOM';              //getting uom names from database to show in as options[each,kg]
var productSaveApiUrl = 'http://127.0.0.1:5000/insertProduct';   //to save the inserted products into database 
var productDeleteApiUrl = 'http://127.0.0.1:5000/deleteProduct';  //to delete a product
